...
import com.example.guessthesong.SongModel

class SongsAdapter(private val imageModelArrayList: ArrayList<SongModel>) : RecyclerView.Adapter<SongsAdapter.ViewHolder>() {
